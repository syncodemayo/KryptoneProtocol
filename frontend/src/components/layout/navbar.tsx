...
export function Navbar() {
  ...
  const { isAuthenticated } = useAuth(); // Using AuthContext for reliable state
  ...
  const navLinks = isAuthenticated ? [
      ...
      // { name: 'My Chats', href: '/chats' } // Future addition
  ] : [
    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-tr from-primary/20 to-blue-500/20 group-hover:from-primary/30 group-hover:to-blue-500/30 transition-all duration-300 border border-white/10 shadow-inner">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-medium tracking-widest text-primary/80 uppercase">Trustless Protocol</span>
            </div>
          </Link>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-[#020817]/95 backdrop-blur-2xl border-b border-white/10 p-4 flex flex-col gap-2 shadow-2xl animate-in slide-in-from-top-5 duration-300">
            ...
            <div className="pt-4 mt-2 border-t border-white/10 flex justify-center w-full">
